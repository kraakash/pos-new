...
/**
 * Sidebar Component
 * Renders the desktop sidebar container matching the AppShell visual layout design system.
 * Keeps links and navigation highlight states synchronized.
 */
export default function Sidebar() {
  ...
  // Generate 2-character initials for profile avatar slot
  const initials = (() => {
  ...
  return (
    <aside className="hidden h-screen w-[230px] shrink-0 flex-col overflow-y-auto bg-[#29283a] px-6 py-7 lg:flex border-r border-white/5 font-sans">
